...
const HomeComp2 = () => {
  ...
  return (
    <div className="about-section" id="home-comp2">
      <div className="main-main-title">
      ...
      <div className="about-container">
        <div className="about-content">
          <h1 className="about-title">
            About <span>Impact Production</span>
          </h1>

          <p className="about-text">
            Impact Production is a creative powerhouse based in Ethiopia,
            dedicated to transforming ideas into impactful experiences. We bring
            together art, design, technology, and community engagement to create
