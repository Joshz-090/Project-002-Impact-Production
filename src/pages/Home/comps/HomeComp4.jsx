...
import designImg from "../../../assets/content.jpg";
import webImg from "../../../assets/event.jpg";
import brandImg from "../../../assets/content.jpg";
import contentImg from "../../../assets/event.jpg";
import socialImg from "../../../assets/content.jpg";
    ...
    <div className="services-container">
      ...
      <div className="services-carousel-container">
        ...
        <div className="carousel-nav-buttons">
          <button className="nav-button prev" onClick={handlePrev} aria-label="Previous Service">
            <svg
          ...
          <button className="nav-button next" onClick={handleNext} aria-label="Next Service">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
